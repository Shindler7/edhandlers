...
def test_err_annotated_msg_valid_full() -> None:
    ...
    result: str | None = err_annotated_msg(err_a, True, None, args, kwargs)
...
def test_err_annotated_msg_not_args() -> None:
    ...
    result: str | None = err_annotated_msg(err_a, False, None, args, {})
...
def test_err_annotated_msg_exclude_args() -> None:
    ...
    result: str | None = err_annotated_msg(err_a, True, exclude, (), kwargs)
